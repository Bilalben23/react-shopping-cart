                ...
                shippedProducts.length > 0 && <>
                    ...
                    <div className='w-full py-2 border-t z-10 flex flex-col items-center space-y-2 fixed bottom-0 bg-white'>
                        ...
                        <div className='flex items-center justify-center space-x-5'>
                            <button type='button' onClick={() => navigate("/")} className='transition hover:opacity-85 px-3 py-1.5 rounded bg-black text-white min-w-[250px]'>Continue Shopping</button>
                            <button type='button' className='transition hover:opacity-85 px-3 py-1.5 bg-black text-white rounded min-w-[250px]' onClick={() => alert("checkout now!")}>Checkout</button>
                        </div>
